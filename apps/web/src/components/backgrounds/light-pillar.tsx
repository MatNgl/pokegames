import { useRef, useEffect, useState, type FC, type CSSProperties } from 'react';
...
const LightPillar: FC<LightPillarProps> = ({
  ...
  if (!webGLSupported) {
    return (
      <div
        className={`absolute left-0 top-0 flex h-full w-full items-center justify-center ${className}`}
        style={{ mixBlendMode }}
      />
    );
  }
