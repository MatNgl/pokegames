...
export function MotusPage() {
  ...
  }, [addLetter, backspace, onEnter]);

  const finished = doneInfo !== null || (state !== null && state.status !== 'PLAYING');
          ...
          {loading ? (
            ...
            <Card className="flex w-full max-w-xl flex-col items-center gap-5 p-6">
              <div className="flex w-full items-start justify-between gap-4">
                <div>
                  <h1 className="text-lg font-extrabold text-foreground">Poké-Motus</h1>
                  <p className="text-sm font-semibold text-muted">Mot du jour, {state.length} lettres</p>
                </div>
