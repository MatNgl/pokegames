...
* **À faire prochaine session (backlog priorisé) :**
  1. **UX globale / accessibilité :** passe transverse (focus visibles, contrastes AA, `aria-*` et rôles, cibles tactiles ≥ 44px, ordre de tabulation, `aria-live` sur les retours de manche, états désactivés).
