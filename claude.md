...
* **À faire prochaine session (backlog priorisé) :**
  1. **Refonte du panneau de choix des niveaux :** une couleur dédiée par niveau (Facile / Moyen / Difficile / Extrême), dans `LevelSelectScreen`, cohérente sur tous les jeux à niveaux.
  2. **Refonte visuelle du jeu Silhouette (Quel est ce Pokémon) :** aligner sur la DA rétro, améliorer la mise en scène de l'arène.
  3. **UX globale :** interface, boutons, accessibilité (focus, contrastes, aria, cibles tactiles).
